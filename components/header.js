      ...
      <div data-role="Header" className={`header ${props.rootClassName} `}>
        <nav className="nav">
          <div className="container">
            <Link href="/">
              <a className="link1 large">Soft UI Design System</a>
            </Link>
            <div className="menu">
              <Link href="/">
                <a className="link2 large">Home</a>
              </Link>
              <span className="text large">Profile</span>
              <span className="text1 large">Coming Soon</span>
            </div>
        ...
        <div data-type="MobileMenu" className="mobile-menu">
          <div className="top">
            <Link href="/">
              <a className="link3 large">Soft UI Design System</a>
            </Link>
          ...
          <div className="mid">
            <div className="menu1">
              <Link href="/">
                <a className="link4 large">Home</a>
              </Link>
              <span className="text2 large">Profile</span>
              <span className="text3 large">Coming Soon</span>
            </div>
          </div>
          <div className="bot">
